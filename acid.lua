local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/killproofs/acid/refs/heads/main/library'))()
local SaveManager = loadstring(game:HttpGet('https://raw.githubusercontent.com/violin-suzutsuki/LinoriaLib/main/addons/SaveManager.lua'))()

local Window = Library:CreateWindow({

    Title = '   acid.lua  |  https://discord.gg/yVWSpt782a  |  Pre Release',
    Center = true,
    AutoShow = true,
    TabPadding = 8,
    MenuFadeTime = 0.7
...
local WatermarkConnection = game:GetService('RunService').RenderStepped:Connect(function()
    ...
    Library:SetWatermark(('Acid.lua | Pre Release | %s fps | %s ms'):format(
        math.floor(FPS),
